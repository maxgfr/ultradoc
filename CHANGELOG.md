...
* **engine:** update shared engines and maintenance tool ([19ad345](https://github.com/maxgfr/ultradoc/commit/19ad345fb756aff573077b489b39fd34b7775692))

## [2.31.9](https://github.com/maxgfr/ultradoc/compare/v2.31.8...v2.31.9) (2026-09-13)


### Bug Fixes

* **engine:** update shared engines and maintenance tool ([a5b4da5](https://github.com/maxgfr/ultradoc/commit/a5b4da565335eb41ba163069a17b1070d62e512e))

## [2.31.8](https://github.com/maxgfr/ultradoc/compare/v2.31.7...v2.31.8) (2026-09-10)


### Bug Fixes

* **engine:** update shared engines and maintenance tool ([474f373](https://github.com/maxgfr/ultradoc/commit/474f37398063d1032acb76fdae57ac34812cebff))
...
* **engine:** separate workflow maintenance from automatic repins ([426df45](https://github.com/maxgfr/ultradoc/commit/426df4550468f932a9a7cf9c11387df37ccf1678))
...
* **engine:** unify pins, repins and shared engine adapters ([f668378](https://github.com/maxgfr/ultradoc/commit/f6683784e82cd172d47ca535e2d2910e080bb10f))
* **engine:** unify pins, repins and shared engine adapters ([979c89d](https://github.com/maxgfr/ultradoc/commit/979c89db2e8d82def08522dd8f86ca606088174b))
* **engine:** unify pins, repins and shared engine adapters ([fa01f82](https://github.com/maxgfr/ultradoc/commit/fa01f8284782de62b6a5b9859e256c30366ad23a))
...
* **engine:** re-pin vendored engines ([5f1d278](https://github.com/maxgfr/ultradoc/commit/5f1d278326f8b20c4049d61c3794da690af76def))
...
* make ultradoc compatible with Codex ([516baa2](https://github.com/maxgfr/ultradoc/commit/516baa2f1fce58513ed8209c079e03a599616831))

# [2.27.0](https://github.com/maxgfr/ultradoc/compare/v2.26.0...v2.27.0) (2026-08-22)


### Features

* **engine:** re-pin vendored engines ([f50897c](https://github.com/maxgfr/ultradoc/commit/f50897c1dc4849defe5f3efca9ba5cf74e693ca0))

# [2.26.0](https://github.com/maxgfr/ultradoc/compare/v2.25.0...v2.26.0) (2026-08-13)


### Features

* **engine:** re-pin vendored engines ([8e96dae](https://github.com/maxgfr/ultradoc/commit/8e96dae693d3b2a49ae7c044b45e8f6ca28ea2b2))
...
* **engine:** re-pin vendored engines ([9e4566c](https://github.com/maxgfr/ultradoc/commit/9e4566c16be32cb9faa36e45e4db3587d0580723))

# [2.23.0](https://github.com/maxgfr/ultradoc/compare/v2.22.0...v2.23.0) (2026-08-10)


### Features

* **engine:** adopt webindex v1.15's harness layer ([f2b7fa4](https://github.com/maxgfr/ultradoc/commit/f2b7fa4fded64d653a7fc9eb56f40dbffd7b6183))
...
* **engine:** re-pin vendored engines ([f0d2b5d](https://github.com/maxgfr/ultradoc/commit/f0d2b5d703cc03019302e64d0d7fb2d594395001))
...
* **pdf,doc:** pin the npx extractor rungs instead of floating on latest ([e5ed825](https://github.com/maxgfr/ultradoc/commit/e5ed82594a7b5b5169f8410d01e54b53a0c8355b))
...
* **engine:** re-pin codeindex v2.27.1 ([d7b363a](https://github.com/maxgfr/ultradoc/commit/d7b363a6b684261c6222df03184e127e44733c91))

## [2.17.1](https://github.com/maxgfr/ultradoc/compare/v2.17.0...v2.17.1) (2026-08-03)


### Bug Fixes

* **searxng:** say when the instance is throttled, not that the query is empty ([08a9fc4](https://github.com/maxgfr/ultradoc/commit/08a9fc464b475852c4cc3e6d21a843d1de62e8a1))
...
* **engine:** re-pin codeindex v2.26.0 ([cdcca66](https://github.com/maxgfr/ultradoc/commit/cdcca6627def45681a6a16e0b65560cec9ca7d64))

# [2.15.0](https://github.com/maxgfr/ultradoc/compare/v2.14.0...v2.15.0) (2026-08-01)


### Features

* **engine:** re-pin codeindex v2.24.1 ([36d3e7b](https://github.com/maxgfr/ultradoc/commit/36d3e7b455c34b5d24b58e4e1ec49b69715221b2))

# [2.14.0](https://github.com/maxgfr/ultradoc/compare/v2.13.0...v2.14.0) (2026-07-31)


### Features

* **engine:** re-pin codeindex v2.22.0 ([54550c7](https://github.com/maxgfr/ultradoc/commit/54550c767a7e1398df1376bc5d4ca45ea4b9d9f0))
...
* **engine:** re-pin codeindex v2.20.1 ([61f9959](https://github.com/maxgfr/ultradoc/commit/61f99596e7fec79beb4f52d0fbf8bf056539d6e5))
