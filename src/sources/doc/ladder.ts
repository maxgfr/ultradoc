...
/**
 * The rungs to try, honouring `ULTRADOC_DOC_ENGINE` (force exactly one, or
 * `none` to disable the ladder) and `ULTRADOC_NO_NPX` (skip the rung that
 * needs an implicit install).
 *
