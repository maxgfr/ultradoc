...
export const SKILL_NAME = "ultradoc";
...
// them:
//
//   <payload>/scripts/ultradoc.mjs  → <payload>/SKILL.md              (installed skill)
//   <repo>/scripts/ultradoc.mjs     → <repo>/skills/ultradoc/SKILL.md (repo-root bundle)
//   <repo>/src/mcp/resources.ts     → <repo>/skills/ultradoc/SKILL.md (source tree, tests)
//
