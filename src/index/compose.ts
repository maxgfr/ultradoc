...
// and `ultradoc firecrawl up|down|status` work from ANY install location (npx
...
export const COMPOSE_YAML = `# Optional, fully-local, no-API-key stack for ultradoc's semantic mode, web
