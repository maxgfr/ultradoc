...
// skills/ultradoc/SKILL.md — the indented `version:` under the frontmatter
// `metadata:` block. The skill is packaged under skills/ultradoc/ (not the repo
// root) so `npx skills add` bundles the engine + references with the SKILL.md.
edit("skills/ultradoc/SKILL.md", (s) => s.replace(/(\n[ \t]+version:[ \t]*)[^\n]+/, `$1${version}`));

console.log(`sync-version: set ${version} in package.json, src/types.ts, skills/ultradoc/SKILL.md`);
